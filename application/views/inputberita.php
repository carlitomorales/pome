...
<?php include('footer.php'); ?>
	...
	$(document).ready(function(){
        ...
        $.cleditor.buttons.image.uploadUrl = "<?php echo base_url();?>inputberita/image_upload";
        $.cleditor.buttons.image.imageListUrl = "<?php echo base_url();?>inputberita/image_list";

                                      ...
                                      <select name="id_jenis_energi" id="id_jenis_energi">
                                          <option selected value="">-- Pilih --</option>
                                            <?php
                                                ...
                                                ?>
                                        </select><span> (* Apabila Jenis Energi yg ingin anda pilih tidak ada dalam pilihan Jenis Energi, harap hubungi admin</span> 
...
<?php include('footer.php'); ?>
	...
	$(document).ready(function(){
		...
		$("#addrow").click(function(){
			...
			if($("#jenis_energi_detail").val() == ''){
				$("#divAlert").removeClass();
				$("#divAlert").addClass('alert alert-error');
				$("#divAlert").html("Jenis energi detail harus dipilih.");
				$("#jenis_energi_detail").focus();
				return false;
			}

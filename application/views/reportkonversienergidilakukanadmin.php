<?php include('header.php'); ?>
			...
			<div>
				<ul class="breadcrumb">
					...
					<li>
						<a href="<?php echo base_url();?>reportkonversienergidilakukanadmin">Rekapitulasi Kegiatan Konservasi Energi Yang Telah Dilakukan</a>
					</li>
				</ul>
			</div>
			...
			<div class="row-fluid sortable">		
				<div class="box span12">
					<div class="box-header well" data-original-title>
						<h2><span class="icon icon-color icon-clipboard"></span>Rekapitulasi Kegiatan Konservasi Energi Yang Telah Dilakukan (Filter)</h2>
					</div>
            ...
            <div class="row-fluid sortable">		
				<div class="box span12">
					<div class="box-header well" data-original-title>
						<h2><span class="icon icon-color icon-clipboard"></span>Rekapitulasi Kegiatan Konservasi Energi Yang Telah Dilakukan (Result)</h2>
					</div>
					<div class="box-content">
            ...
            <div class="row-fluid sortable">		
				<div class="box span12">
					<div class="box-header well" data-original-title>
						<h2><span class="icon icon-color icon-clipboard"></span>Rekapitulasi Kegiatan Konservasi Energi Yang Telah Dilakukan (Chart)</h2>
					</div>
...
<script language="javascript">
	...
	$(document).ready(function(){
		oTable = $("#datatable").dataTable({
			...
			"bProcessing": true,
			"bServerSide": true,
			"sAjaxSource": "<?php echo base_url();?>reportkonversienergidilakukanadmin/get_list",
			"sServerMethod" : "POST",
				...
				"aButtons": [
					{
						...
						"fnClick": function(){
							...
							iframe.src = '<?php echo base_url();?>reportkonversienergidilakukanadmin/exportexcel?nama_perusahaan='+namaperusahaan+'&tahun='+tahun+'&tipe_perusahaan='+tipeperusahaan+'&sub_sektor='+subsektor;
		...
		$('#tipe_perusahaan').chainSelect('#sub_sektor','<?php echo base_url();?>reportkonversienergidilakukanadmin/getcombosubsektor',
		{ 
	...
	function generateChart(){
		...
		var subsektor =  $("#sub_sektor").val();
                var tipeperusahaan =  $("#tipe_perusahaan").val();
		chartData = AmCharts.loadJSON('<?php echo base_url();?>reportkonversienergidilakukanadmin/getpiedata?tahun='+tahun+'&sub_sektor='+subsektor+'&tipe_perusahaan='+tipeperusahaan);
		chart.dataProvider = chartData;
		chart.validateData();
	}
	...
	function generateChartStack(){
		var subsektor =  $("#sub_sektor").val();
		chartData = AmCharts.loadJSON('<?php echo base_url();?>reportkonversienergidilakukanadmin/getlinedata?sub_sektor='+subsektor);

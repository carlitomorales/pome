<?php include('header.php'); ?>
			...
			<div>
				<ul class="breadcrumb">
					...
					<li>
						<a href="<?php echo base_url();?>reportkonsumsienergispesifik">Rekapitulasi Konsumsi Energi Spesifik</a>
					</li>
				</ul>
			</div>
...
<script language="javascript">
	$(document).ready(function(){			
		$('#tipe_perusahaan').chainSelect('#sub_sektor','<?php echo base_url();?>reportkonsumsienergispesifik/getcombosubsektor',
		{ 
	...
	function populateTable(){
		...
		j++;
		aryJSONColTable.push({"sTitle": "Konsumsi Energi Spesifik", "mDataProp":j});
		j++;
		...
		var oTable = $("#datatable").dataTable({
			...
			"bProcessing": true,
			"bServerSide": true,
			"sAjaxSource": "<?php echo base_url();?>reportkonsumsienergispesifik/get_list",
			"sServerMethod" : "POST",
			...
			"oTableTools": {
				"aButtons": [
				{
					...
					"fnClick": function(){
						...
						iframe.src = '<?php echo base_url();?>reportkonsumsienergispesifik/exportexcel?nama_perusahaan='+namaperusahaan+'&tahun='+tahun+'&tipe_perusahaan='+tipeperusahaan+'&sub_sektor='+subsektor;
	...
	function generateChartStack(){
		...
		var tipeperusahaan =  $("#tipe_perusahaan").val();
		var subsektor =  $("#sub_sektor").val();
		chartData = AmCharts.loadJSON('<?php echo base_url();?>reportkonsumsienergispesifik/getlinedata?tahun='+tahun);

<?php include('header.php'); ?>
			...
			<div>
				<ul class="breadcrumb">
					...
					<li>
						<a href="<?php echo base_url();?>reportkonsumsienergispesifikadmin">Laporan Konsumsi Energi Spesifik</a>
					</li>
				</ul>
			</div>
			...
			<div class="row-fluid sortable">		
				<div class="box span12">
					<div class="box-header well" data-original-title>
						<h2><span class="icon icon-color icon-clipboard"></span> Laporan Konsumsi Energi Spesifik (Filter)</h2>
					</div>
            ...
            <div class="row-fluid sortable">		
				<div class="box span12">
					<div class="box-header well" data-original-title>
						<h2><span class="icon icon-color icon-clipboard"></span> Laporan Konsumsi Energi Spesifik (Result)</h2>
					</div>
					<div class="box-content">
            ...
            <div class="row-fluid sortable">		
				<div class="box span12">
					<div class="box-header well" data-original-title>
						<h2><span class="icon icon-color icon-clipboard"></span> Laporan Pemakaian Energi (Chart)</h2>
					</div>
...
<script language="javascript">
	...
	function generateChart(){
		var tahun = $("#tahun").val();
		var subsektor =  $("#sub_sektor").val();
		chartData = AmCharts.loadJSON('<?php echo base_url();?>reportpemakaianenergiadmin/getpiedata?tahun='+tahun+'&sub_sektor='+subsektor);
		chart.dataProvider = chartData;
		chart.validateData();
	}
	...
	function generateChartStack(){
		var subsektor =  $("#sub_sektor").val();
		chartData = AmCharts.loadJSON('<?php echo base_url();?>reportpemakaianenergiadmin/getlinedata?sub_sektor='+subsektor);

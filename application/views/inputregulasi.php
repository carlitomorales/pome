<?php include('header.php'); ?>
			<div>
				<ul class="breadcrumb">
					...
					<li>
						<a href="#">Input Informasi Lain</a></li>
				</ul>
			</div>
            	...
            	<div class="box span12">
					...
					<div class="box-content">
                    	<table class="table table-striped table-bordered bootstrap-datatable" id="datatable1">
                          <thead>
                              <tr>
                                  <th align="center">Nama Informasi</th>
					...
					<div class="box-content">
                    	...
                    	<form id="frmAdd" class="form-horizontal" action="" method="post">
                            <div class="control-group">
							  <label class="control-label" for="nama_regulasi">Nama Informasi</label>
							  <div class="controls">
                          ...
                          <div class="control-group">
                            <label class="control-label" for="thumbnail">File Informasi</label>
                            <div class="controls">
...
<?php include('footer.php'); ?>
	...
	$(document).ready(function(){
		...
		oTable = $("#datatable1").dataTable({
			...
			"bProcessing": true,
			"bServerSide": true,
			"sAjaxSource": "<?php echo base_url();?>inputregulasi/get_list",
			"sServerMethod" : "POST",
		...
		$(".btnedit").live('click', function(){
			var id = $(this).attr('id');
			var url = "<?php echo base_url();?>inputregulasi/getDetail/"+id; // the script where you handle the form input.
		...
		$("#addrow").click(function(){
			...
			$.ajaxFileUpload({
				url: "<?php echo base_url();?>inputregulasi/save",
				secureuri: false,
		...
		$(".btndelete").live('click', function(){
			...
			if(conf){
				var url = "<?php echo base_url();?>inputregulasi/hapus/"+id; // the script where you handle the form input.
				$.post(url, '', function(data){
				   oTable.fnDraw();
				    $("#id_regulasi").val('');
					$("#nama_regulasi").val('');

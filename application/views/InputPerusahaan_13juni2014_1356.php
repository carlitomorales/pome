...
<html lang="en">
	...
	<script type="text/javascript">
		function hideDiv(){ document.getElementById('divLainLain').style.display = 'none'; } 
		function showDiv(){ document.getElementById('divLainLain').style.display = 'inline'; } 
    </script>
							...
							<div class="control-group">
							  ...
							  <div class="controls">
                                ...
                                <? function createYears($start_year, $end_year, $id='IdThnAwal', $selected=null)
									...
									echo createYears(1900, 2020, 'IdThnAwal', null);
								?>
						      </div>
						    </div>
							<div class="control-group">

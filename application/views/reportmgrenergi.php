<?php include('header.php'); ?>
			...
			<div>
				<ul class="breadcrumb">
					...
					<li>
						<a href="<?php echo base_url();?>reportmgrenergi">Rekapitulasi Perusahaan Yang Sudah Memiliki Manager Energi</a>
					</li>
				</ul>
			</div>
			...
			<div class="row-fluid sortable">		
				<div class="box span12">
					<div class="box-header well" data-original-title>
						<h2><span class="icon icon-color icon-clipboard"></span>Rekapitulasi Perusahaan Yang Sudah Memiliki Manager Energi (Filter)</h2>
					</div>
            ...
            <div class="row-fluid sortable">		
				<div class="box span12">
					<div class="box-header well" data-original-title>
						<h2><span class="icon icon-color icon-clipboard"></span>Rekapitulasi Perusahaan Yang Sudah Memiliki Manager Energi (Result)</h2>
					</div>
					<div class="box-content" id="dataplaceholder">
                    	...
                    	<thead>
							<tr>
								  ...
								  <th valign="middle">Nama Manager Energi</th>
								  <th valign="middle"> No Telp </th>
            ...
            <div class="row-fluid sortable">		
				<div class="box span12">
					<div class="box-header well" data-original-title>
						<h2><span class="icon icon-color icon-image"></span> Chart Rekapitulasi Perusahaan Yang Sudah Memiliki Manager Energi</h2>
					</div>
...
<script language="javascript">
				...
				"aButtons": [
					{
						...
						"fnClick": function(){
							...
							iframe.src = '<?php echo base_url();?>reportmgrenergi/exportexcel?nama_perusahaan='+namaperusahaan+'&tipe_perusahaan='+tipeperusahaan+'&sub_sektor='+subsektor;
	...
	function generateChartStack(){
		...
		var tipeperusahaan =  $("#tipe_perusahaan").val();
		var subsektor =  $("#sub_sektor").val();
		chartData = AmCharts.loadJSON('<?php echo base_url();?>reportmgrenergi/getlinedata?nama_perusahaan='+namaperusahaan+'&tahun='+tahun+'&tipe_perusahaan='+tipeperusahaan+'&sub_sektor='+subsektor);

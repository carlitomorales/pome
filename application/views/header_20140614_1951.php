...
?>                  <?php if($this->session->userdata('privilege_id') != '2'){?>
                    ...
                    <div id="lihatstatistik" class="collapse">
                    	<ul class="nav nav-tabs nav-stacked main-menu">
                            ...
                            <li><a class="ajax-link" href="<?php echo base_url();?>chartkegiatanefesiensi"><span class="icon icon-image"></span><span class="hidden-tablet"> Kegiatan Efesiensi Energi</span></a></li>    
                            <li><a class="ajax-link" href="<?php echo base_url();?>chartrencanaefesiensi"><span class="icon icon-image"></span><span class="hidden-tablet"> Rencana Efesiensi Energi</span></a></li>
                        </ul>
                    </div>
					<?php if($this->session->userdata('privilege_id') == '2'){?>
                    <ul class="nav nav-tabs nav-stacked main-menu">

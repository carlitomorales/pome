<?php include('header.php'); ?>
			...
			<div>
				<ul class="breadcrumb">
					...
					<li>
						<a href="<?php echo base_url();?>reportpemakaianenergiadmin">Konsumsi Energi Spesifik</a>
					</li>
				</ul>
			</div>
                        	...
                        	<div class="span6">
                            	<div class="box-content">
                                    <div class="control-group">
                                      ...
                                      <div class="controls">
                                        <select id="tahun" name="tahun[]" multiple="multiple" data-rel="chosen">
                                       	<?php
...
<script language="javascript">
	...
	AmCharts.ready(function(){		
		...
		graph.lineAlpha = 0;
		graph.fillAlphas = 1;
		graph.balloonText = "<span style='color:#555555;'>[[category]]</span><br><span style='font-size:14px'>[[title]]:<b>[[value]] (GJoule)</b></span>";
	...
	function generateChartStack(){
		var tahun =  $("#tahun").val();
		chartData = AmCharts.loadJSON('<?php echo base_url();?>chartkonsumsienergispesifik/getlinedata?tahun='+tahun);

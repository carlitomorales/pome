                    	...
                    	<form id="frmAdd" class="form-horizontal" action="<?php if($this->data['idnya'] ==''){echo base_url()."orgenergi/save";}else{echo base_url()."orgenergi/edit";} ?>" method="post" enctype="multipart/form-data" >                        	
                            <div class="control-group">
							  ...
							  <div class="control-group">
							    ...
							    <label class="control-label" for="fileInput2">Pilih File<br>
							      <dfn>*) Jika ada, lampirkan bukti sertifikat</dfn></label>
							    <div class="controls">
							      <input class="input-file uniform_on" id="IdFileOrg" type="file" name="FileSertifikat"><?php if($this->data['pathfilesertifikat'] !=''){ ?> | <a href="uploads/<?php echo $this->data['pathfilesertifikat']; ?>"><?php echo $this->data['pathfilesertifikat']; ?></a><?php } ?>
						        </div>
						      </div>						      

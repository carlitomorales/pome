                    	...
                    	<form id="frmAdd" class="form-horizontal" action="" method="post">                        	
                            ...
                            <div class="control-group">
                             ...
                             <div class="control-group">
                                    ...
                                    <div class="controls">
                                      <input class="input-xlarge focused" id="konversi" name="konversi" type="text">
                                    </div>
                              </div>
                              <div class="control-group">
                                    <label class="control-label" for="gjoule">GJoule</label>
                                    <div class="controls">
                                      <input class="input-xlarge focused" id="gjoule" name="gjoule" type="text" readonly>
                                    </div>
                              </div>
			...
			"aoColumnDefs":[
				...
				},
				{
					...
					"fnRender": function(obj){
						...
						return '<div align="right">'+obj.aData[4]+'&nbsp;'+satuan+'</div>';
					}
				},
				{
					"aTargets":[3],

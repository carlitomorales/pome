<?php include('header.php'); ?>
			...
			<div>
				<ul class="breadcrumb">
					...
					<li>
						<a href="<?php echo base_url();?>chartkegiatan">Statistik Kegiatan Konservasi Energi Yang Telah Dilakukan</a>
					</li>
				</ul>
			</div>
			...
			<div class="row-fluid sortable">		
				<div class="box span12">
					<div class="box-header well" data-original-title>
						<h2><span class="icon icon-color icon-clipboard"></span>Statistik Kegiatan Konservasi Energi Yang Telah Dilakukan (Filter)</h2>
					</div>
            ...
            <div class="row-fluid sortable">		
				<div class="box span12">
					<div class="box-header well" data-original-title>
						<h2><span class="icon icon-color icon-clipboard"></span>Statistik Kegiatan Konservasi Energi Yang Telah Dilakukan (Chart)</h2>
					</div>
					<div class="box-content">
                    	<div class="row-fluid">
...
<script language="javascript">
	...
	$(document).ready(function(){
		...
		$('#tipe_perusahaan').chainSelect('#sub_sektor','<?php echo base_url();?>chartkegiatan/getcombosubsektor',
		{ 
	...
	AmCharts.ready(function(){
		...
		chart.addTitle("Klik peralatan untuk melihat kegiatan yang telah dilakukan ");		
	...
	function generateChart(){
		...
		chartData = AmCharts.loadJSON('<?php echo base_url();?>chartkegiatan/getpiedata?tahun='+tahun+'&sub_sektor='+subsektor+'&tipe_perusahaan='+tipeperusahaan);
		chart.dataProvider = chartData;
		chart.validateData();
	}
</script>
<?php include('header.php'); ?>
			...
			<div>
				<ul class="breadcrumb">
					...
					<li>
						<a href="<?php echo base_url();?>chartsudahlapor">Statistik Perusahaan Yang Sudah Mengisi Laporan</a>
					</li>
				</ul>
			</div>
			...
			<div class="row-fluid sortable">		
				<div class="box span12">
					<div class="box-header well" data-original-title>
						<h2><span class="icon icon-color icon-clipboard"></span>Statistik Perusahaan Yang Sudah Mengisi Laporan (Filter)</h2>
					</div>
            ...
            <div class="row-fluid sortable">		
				<div class="box span12">
					<div class="box-header well" data-original-title>
						<h2><span class="icon icon-color icon-image"></span> Chart Perusahaan Yang Sudah Mengisi Laporan</h2>
					</div>
...
<script language="javascript">
	...
	AmCharts.ready(function(){		
		...
		graph.title = "Sedang Diverifikasi";
		graph.labelText = "[[value]]";
		graph.valueField = "Sedang";
		graph.type = "column";
		graph.fillColors = "#0000FF";
		graph.lineAlpha = 0;
		graph.fillAlphas = 1;
	...
	function generateChartStack(){
		...
		var tipeperusahaan =  $("#tipe_perusahaan").val();
		var subsektor =  $("#sub_sektor").val();
		chartData = AmCharts.loadJSON('<?php echo base_url();?>chartsudahlapor/getlinedata?nama_perusahaan='+namaperusahaan+'&tahun='+tahun+'&tipe_perusahaan='+tipeperusahaan+'&sub_sektor='+subsektor);

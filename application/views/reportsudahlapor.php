<?php include('header.php'); ?>
			...
			<div>
				<ul class="breadcrumb">
					...
					<li>
						<a href="<?php echo base_url();?>reportsudahlapor">Rekapitulasi Perusahaan Yang Sudah Mengisi Laporan</a>
					</li>
				</ul>
			</div>
			...
			<div class="row-fluid sortable">		
				<div class="box span12">
					<div class="box-header well" data-original-title>
						<h2><span class="icon icon-color icon-clipboard"></span>Rekapitulasi Perusahaan Yang Sudah Mengisi Laporan (Filter)</h2>
					</div>
            ...
            <div class="row-fluid sortable">		
				<div class="box span12">
					<div class="box-header well" data-original-title>
						<h2><span class="icon icon-color icon-clipboard"></span>Rekapitulasi Perusahaan Yang Sudah Mengisi Laporan (Result)</h2>
					</div>
					<div class="box-content" id="dataplaceholder">
                    	...
                    	<thead>
							<tr>
								  ...
								  <th valign="middle">Tanggal Submit</th>
								  <th valign="middle">Status Laporan</th>
...
<script language="javascript">
	$(document).ready(function(){	
		var oTable = $("#datatable").dataTable({
			...
			"bProcessing": true,
			"bServerSide": true,
			"sAjaxSource": "<?php echo base_url();?>reportsudahlapor/get_list",
			"sServerMethod" : "POST",
			...
			"fnRowCallback": function( nRow, aData, iDisplayIndex, iDisplayIndexFull ) {
					if ( aData[3] == "Belum Melaporkan" )
					{
						$('td', nRow).css('background-color', '#eddbe3');
					}
					else if ( aData[3] == "Sedang Diverifikasi" )
					{
						$('td', nRow).css('background-color', '#FFFF66');
					}
					else if ( aData[3] == "Sudah Melaporkan" )
					{
						$('td', nRow).css('background-color', '#ccddbb');
					}
					else if ( aData[3] == "Ditolak" )
					{
						$('td', nRow).css('background-color', '#000000');
					}
				},
			"oTableTools": {
				"aButtons": [
				{
					...
					"fnClick": function(){
						...
						iframe.src = '<?php echo base_url();?>reportsudahlapor/exportexcel?nama_perusahaan='+namaperusahaan+'&tahun='+tahun+'&tipe_perusahaan='+tipeperusahaan+'&sub_sektor='+subsektor;
	...
	AmCharts.ready(function(){		
		...
		graph.title = "Sudah Memiliki Organisasi Manajemen Energi";
		...
		graph = new AmCharts.AmGraph();
		graph.title = "Belum Memiliki Organisasi Manajemen Energi";
		graph.labelText = "[[value]]";
	...
	function generateChartStack(){
		...
		var tipeperusahaan =  $("#tipe_perusahaan").val();
		var subsektor =  $("#sub_sektor").val();
		chartData = AmCharts.loadJSON('<?php echo base_url();?>reportsudahlapor/getlinedata?nama_perusahaan='+namaperusahaan+'&tahun='+tahun+'&tipe_perusahaan='+tipeperusahaan+'&sub_sektor='+subsektor);

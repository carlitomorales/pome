   ...
   <div class="row-fluid"><!--/span-->
            	<div class="box span8">
                	<div  align="center" class="box-content">
                    	...
                    	<h1>di</h1>
                    	<h1>Sistem Pelaporan Online</h1>
                    	<h1>Managemen Energi</h1>
                        <hr>
                       </br>
                       </br>
                       </br>
...
<script language="javascript">
	$(document).ready(function(){
		...
		var dlgEdit = $('#dialogKegiatan').dialog({
		...
		$("#kalender").fullCalendar({
			...
			eventClick:function(calEvent, jsEvent, view){
				...
				console.log('date :'+date.toYMD());
				dlgEdit.load('<?php echo base_url();?>home/listeventsbydate/'+date.toYMD(), function(){
					dlgEdit.dialog('open');
				});
			}
		});

<?php include('header.php'); ?>
			...
			<div>
				<ul class="breadcrumb">
					...
					<li>
						<a href="<?php echo base_url();?>reportpemakaianenergiadmin">Statistik Peralatan Pemanfaat Energi Utama</a>
					</li>
				</ul>
			</div>
			...
			<div class="row-fluid sortable">		
				<div class="box span12">
					<div class="box-header well" data-original-title>
						<h2><span class="icon icon-color icon-clipboard"></span>Statistik Peralatan Pemanfaat Energi Utama (Filter)</h2>
					</div>
            ...
            <div class="row-fluid sortable">		
				<div class="box span12">
					<div class="box-header well" data-original-title>
						<h2><span class="icon icon-color icon-clipboard"></span>Statistik Peralatan Pemanfaat Energi Utama (Chart)</h2>
					</div>
					<div class="box-content">
                    	<div class="row-fluid">
...
<script language="javascript">
	...
	$(document).ready(function(){
		...
		$('#tipe_perusahaan').chainSelect('#sub_sektor','<?php echo base_url();?>chartperalatanpemanfaat/getcombosubsektor',
		{ 
	...
	AmCharts.ready(function(){
		...
		chart.addTitle("Klik peralatan untuk melihat jenis energi yang digunakan");		
	...
	function generateChart(){
		...
		chartData = AmCharts.loadJSON('<?php echo base_url();?>chartperalatanpemanfaat/getpiedata?tahun='+tahun+'&sub_sektor='+subsektor+'&tipe_perusahaan='+tipeperusahaan);
		chart.dataProvider = chartData;
		chart.validateData();
	}
</script>
                        ...
                        <div id="form-wizard-1" class="step">
                            ...
                            <div class="control-group">
                             ...
                             <div id="form-wizard-2" class="step">
                               ...
                               <div class="control-group">
                            	...
                            	<div class="control-group">
                                    ...
                                    <div class="controls">
                                      <input class="input-xlarge focused" id="IdJnsProduksi" type="text">
                                    </div>
                                  </div>
                                  <div class="control-group">
                                    <label class="control-label" for="IdJumlah">Jumlah</label>
                                    <div class="controls">
                                      <input class="input-xlarge focused" id="IdJumlah" type="text">
                                    </div>
                                  </div>
                                  <div class="control-group">
                                    <label class="control-label" for="IdSatuan">Satuan</label>
                                    <div class="controls">
                                      <input class="input-xlarge focused" id="IdSatuan" type="text">
                                    </div>
                             ...
                             <div id="form-wizard-4" class="step">
							  ...
							  <div class="controls">
							    <input class="input-xlarge focused" id="IdProduksi" type="text">
                            ...
                            <div class="control-group">
                              ...
                              <table class="table">
                               ...
                               <div id="form-wizard-7" class="step">
							   <div class="step-title">
                               	 <i>7</i>

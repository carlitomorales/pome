             ...
             <div class="row-fluid">
                <div class="box span12">
					...
					<?php if($this->session->userdata('privilege_id') != '2'){?>
						...
						<span class="btn btn-primary" onClick="document.location='<?php echo base_url();?>orgenergi '" style="float:center">Edit</span>
	...
	$(document).ready(function(){
		...
		oTableJP = $("#datatableJP").dataTable({
			"fnFooterCallback": function (nRow, aaData, iStart, iEnd, aiDisplay) {
					...
					nCells[1].innerHTML=formatCurrency(parseFloat(iTotalMarket),0)+" ton";
			...
			"aoColumnDefs":[
				...
				},
				{
					"aTargets":[2],
					"fnRender": function(obj){
						return formatCurrency(obj.aData[2],0)+' ton';
					}
				}
			]
		});

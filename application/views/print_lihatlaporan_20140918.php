            	...
            	<div class="box span12">
					...
					<div class="box-content">                    	
							...
							<div class="control-group">
							 ...
							 <div class="control-group">
                                <label class="control-label1" for="org_manajemen_energi"> Ada/tidak Kebijakan Efisiensi Energi Perusahaan</label>
								<label class="control-labelisi" for="isi_org_manajemen_energi">: <?php echo $this->data['kebijakan'];?></label>
							</div>
							<div class="control-group">
                                <label class="control-labelsub" for="file_manajemen_energi">File Dokumen Kebijakan Efisiensi Energi Perusahaan  </label>
								<label class="control-labelisi" for="isi_org_manajemen_energi">: <?php if($this->data['pathfilekebijakanp'] !=''){ ?>  <a href="uploads/<?php echo $this->data['pathfilekebijakanp']; ?>"><?php echo $this->data['pathfilekebijakanp']; ?></a><?php } ?></label>

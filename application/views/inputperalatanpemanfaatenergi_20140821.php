                ...
                <div class="box span12">
					...
					<div class="box-content">
                    	<table class="table table-striped table-bordered bootstrap-datatable" id="datatable1">
                          ...
                          <p style="font-size:18px"><b>Total pemakaian energy untuk satu atau lebih peralatan harus mencapai minimal 60%.</b></p>
                             ...
                             <div class="control-group">
                                    ...
                                    <div class="controls">
                                      <div class="input-append">
										...
										<input type="hidden" class="input-small focused" id="original_unit_detail" name="original_unit_detail" type="text">
										<input type="hidden" class="input-small focused" id="original_unit_detail_peralatan" name="original_unit_detail_peralatan" type="text">
										<input type="hidden" class="input-small focused" id="original_unit_sisa" name="original_unit_sisa" type="text" readonly>
                                      </div>
                                    </div>
                              </div>
                             <div class="control-group">
             ...
             <div class="row-fluid">
                <div class="box span12">
                	<div class="box-content">
						...
						<span id="btnext"  class="btn btn-primary" onClick="document.location='<?php echo base_url();?>kegiatankonservasinew'" style="float:right; display:none; ">Next</span>
	...
	$(document).ready(function(){
		...
		oTable = $("#datatable1").dataTable({
			"fnFooterCallback": function (nRow, aaData, iStart, iEnd, aiDisplay) {
					...
					iTotalPersen = parseInt(0);
					for ( var i=0 ; i<aaData.length ; i++ )
					{
						iTotalGJoule += parseInt(aaData[i][3].replace(/,/g, "").replace("ton","")*1);
						iTotalPersen += parseInt(aaData[i][4].replace(/,/g, "").replace("%","")*1);

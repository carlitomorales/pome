			...
			<div class="span2 main-menu-span">
				<div class="well nav-collapse sidebar-nav">                    
                    ...
                    <div id="permen" class="collapse">
                        <ul class="nav nav-tabs nav-stacked main-menu"> 
                        	<li><a class="ajax-link" href="<?php echo base_url();?>doc/uu-30-2007.pdf" target="_blank"><span class="icon icon-pdf"></span><span class="hidden-tablet"> Undang-Undang No. 30 Tahun 2007</span></a></li>
                            <li><a class="ajax-link" href="<?php echo base_url();?>doc/PP 70 2009.pdf" target="_blank"><span class="icon icon-pdf"></span><span class="hidden-tablet"> Peraturan Pemerintah No. 70 - 2009</span></a></li>
                            <li><a class="ajax-link" href="<?php echo base_url();?>doc/No.14 Tahun 2012.pdf" target="_blank"><span class="icon icon-pdf"></span><span class="hidden-tablet"> Peraturan Menteri No. 14 - 2012</span></a></li>
                    ...
                    <ul class="nav nav-tabs nav-stacked main-menu">
						<li class="nav-header hidden-tablet" data-toggle="collapse" data-target="#infolain" style="cursor:pointer">Informasi Lainnya</li>
                    </ul>
                    <div id="infolain" class="collapse">
                        <ul class="nav nav-tabs nav-stacked main-menu"> 
                        	<?php 
					...
					$regulasi=$query->result_array();
                        	...
                        	<li><a class="ajax-link" href="<?php echo base_url();?>doc/<?php echo $row['file_regulasi'];?>" target="_blank"><span class="icon icon-pdf"></span><span class="hidden-tablet"> <?php echo $row['nama_regulasi'];?></span></a></li>
                        	<?php } ?>
...
?>                  <?php if($this->session->userdata('privilege_id') != '2'){?>
                    ...
                    <div id="lihatlaporan" class="collapse">
                        ...
                        <?php if($this->session->userdata('privilege_id') == '2'){?>
                            ...
                            <li><a class="ajax-link" href="<?php echo base_url();?>reportkonsumsienergispesifikadmin"><span class="icon icon-document"></span><span class="hidden-tablet"> Konsumsi Energi Spesifik</span></a></li>
                    ...
                    <div id="lihatstatistik" class="collapse">
                    	<ul class="nav nav-tabs nav-stacked main-menu">
                            <li><a class="ajax-link" href="<?php echo base_url();?>chartkonsumsienergispesifik"><span class="icon icon-image"></span><span class="hidden-tablet"> Konsumsi Energi Spesifik</span></a></li>
					...
					<?php if($this->session->userdata('privilege_id') == '2'){?>
                    <ul class="nav nav-tabs nav-stacked main-menu">
                        <li id="liRegistrasi" style="display:list-item;cursor:pointer;" class="nav-header hidden-tablet" data-toggle="collapse" data-target="#registrasi">Administrator</li>
                    </ul>
                    <div id="registrasi" class="collapse">
                    	<ul class="nav nav-tabs nav-stacked main-menu">
                        	...
                        	<li id="lidetailperusahaanItem" style="display:list-item"><a class="ajax-link" href="<?php echo base_url();?>user/detailperusahaan"><span class="icon icon-users"></span><span class="hidden-tablet"> Detail Perusahaan</span></a></li>
                        </ul>
                    </div>

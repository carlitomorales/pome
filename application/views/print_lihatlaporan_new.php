...
<div class="row-fluid">
    <table class="table table-striped table-bordered bootstrap-datatable" id="datatableAUA">
        ...
        foreach ($tbaudit1 as $row) {
			...
			if ($row->bulan_pelaksanaan != '' or $row->tahun_pelaksanaan != '' or is_null($row->bulan_pelaksanaan) or is_null($row->tahun_pelaksanaan)) {
...
<div class="row-fluid">
    <table class="table table-striped table-bordered bootstrap-datatable" id="datatableRAUA">
        ...
        <?php
        foreach ($tbraudit1 as $row) {
			if ($row->jenis_peralatan_lain != '') {
				$peralatan =  $row->jenis_peralatan . " (" . $row->jenis_peralatan_lain . ")"
			} else {
				$peralatan =  $row->jenis_peralatan
			}
            echo "<tr>";
            echo "<th>" . $peralatan . " </th>";

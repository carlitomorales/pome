...
<html lang="en">
	...
	function addrow()
	{
		...
		$(".table > tbody:last").after('<tr><td>'+kegiatan+'</td><td>'+targetgjoule+'</td><td>'+targetpersen+'</td><td>'+keterangan+'</td><td><a class="editlink" style="cursor:pointer">Edit</a> | <a class="dellink" style="cursor:pointer">Del</a></td></tr>');
	}
    </script>
...
<div id="content" class="span10">
			...
			<div class="row-fluid sortable"><!--/span-->
						...
						<form id="form-wizard" class="form-horizontal row-fluid well" action="<?php echo base_url();?>ManajemenEnergi/step8">
                             <div id="form-wizard-5" class="step">
							   <div class="step-title">
								 <i>7</i>
                                 <h5>Rencana Kegiatan Konservasi Energi</h5>
								 <span>7 dari 8</span>
							   </div>
						  ...
						  <div class="control-group">
							<label class="control-label" for="keterangan">Keterangan (Jadwal, dll)</label>
							<div class="controls">

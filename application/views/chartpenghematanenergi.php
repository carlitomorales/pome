<?php include('header.php'); ?>
			...
			<div>
				<ul class="breadcrumb">
					...
					<li>
						<a href="<?php echo base_url();?>reportpemakaianenergiadmin">Penghematan Energi Per Sub Sektor</a>
					</li>
				</ul>
			</div>
			...
			<div class="row-fluid sortable">		
				<div class="box span12">
					<div class="box-header well" data-original-title>
						<h2><span class="icon icon-color icon-clipboard"></span>Penghematan Energi Per Sub Sektor (Filter)</h2>
					</div>
            ...
            <div class="row-fluid sortable">		
				<div class="box span12">
					<div class="box-header well" data-original-title>
						<h2><span class="icon icon-color icon-clipboard"></span>Penghematan Energi Per Sub Sektor (Chart)</h2>
					</div>
					<div class="box-content">
                    	<div class="row-fluid">
...
<script language="javascript">
	...
	var chartData = [{"subsektor":"none","penghematan":0}];
	...
	chart = AmCharts.makeChart("chartdiv", {
		...
		"graphs": [{
			...
			"fillAlphas": 0.9,
			"lineAlpha": 0.2,
			"title": "Jumlah penghematan energi",
			"type": "column",
			"valueField": "penghematan",
			"labelText":"[[value]]"
		}],
	...
	function generateChart(){
		...
		chartData = AmCharts.loadJSON('<?php echo base_url();?>chartpenghematanenergi/getpiedata?tahun='+tahun+'&tipe_perusahaan='+tipeperusahaan+'&sub_sektor='+subsektor);

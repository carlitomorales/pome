...
class kegiatankonservasinew_model extends CI_Model {
	...
	{
		$this->db->insert('t_kegiatan_konservasi_new', $data);
		$id = $this->db->insert_id();
		return (isset($id)) ? $id : FALSE;
	}
	public function insertLain($data)
	{
		$this->db->insert('t_kegiatan_konservasi_lain', $data);
		$id = $this->db->insert_id();
		return (isset($id)) ? $id : FALSE;
	}
	public function edit($id, $data)
	{
		...
		$this->db->update('t_kegiatan_konservasi_new',$data);		
		return true;
	}
	public function editLain($id, $data)
	{
		$this->db->where('id_kegiatan_konservasi_lain',$id);
		$this->db->update('t_kegiatan_konservasi_lain',$data);		
		return true;
	}
	...
	{
		$this->db->where('id_kegiatan_konservasi',$id);
		$this->db->delete('t_kegiatan_konservasi_new');		
		return true;
	}
	public function delLain($id)
	{
		$this->db->where('id_kegiatan_konservasi_lain',$id);
		$this->db->delete('t_kegiatan_konservasi_lain');		
		return true;
	}
	
	public  function getById($id){
		$this->db->where('id_kegiatan_konservasi',$id);
		$query = $this->db->get('t_kegiatan_konservasi_new');
		return $query->result();
	}
	public  function getByIdLain($id){
		$this->db->where('id_kegiatan_konservasi_lain',$id);
		$query = $this->db->get('t_kegiatan_konservasi_lain');
		return $query->result();
	}

...
class lihatlaporan_model extends CI_Model {
	...
	{
		$this->db->select('c.NamaSubsektor,jenis_produksi, jumlah, satuan, id_jenis_produksi', false)
	...
	{
		$this->db->select('b.JenisEnergi as JenisEnergi, c.detail_jenis_energi as detail_jenis_energi, a.jenis_energi_lain as jenis_energi_lain, a.original_unit as original_unit, a.gjoule as gjoule, a.id_pemakaian_energi as id_pemakaian_energi, b.Satuan AS Satuan', false)
			->where('a.id_perusahaan = '.$IdPerusahaanP)

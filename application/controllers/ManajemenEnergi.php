...
class ManajemenEnergi extends CI_Controller {
	...
	function listperalatanpemanfaatenergi(){
		$id_perusahaan = 0; //$this->session->userdata('id_perusahaan');
		$tahun = date("Y");
		$this->datatables->select('a.jenis_peralatan as `jenis_peralatan`, a.id_jenis_energi as `id_jenis_energi`, b.JenisEnergi as `JenisEnergi`, a.jenis_energi_lain as `jenis_energi_lain`, a.original_unit as `original_unit`, a.gjoule as `gjoule`, a.id_peralatan_pemanfaat_energi as `id_peralatan_pemanfaat_energi`')

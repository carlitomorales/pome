...
class orgenergi extends CI_Controller {
 ...
 public function save()
		...
		$FileUploadsSertifikat = 'FileSertifikat';
				...
				if($_FILES['FileSertifikat']['name'] !=''){
					list($thefilenamesertifikat,$theextsertifikat) = explode(".", trim($_FILES['FileSertifikat']['name']));
		...
		$this->db->trans_start();
			$data = array(
				...
				'PathFileOrg' => $filenameorg,
				'PathFileSertifikat' => $filenamesertifikat,

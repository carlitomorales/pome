...
class Rencanakonservasi extends CI_Controller {
	...
	function save(){
		...
		if($this->db->trans_status() === FALSE){
			$status = "error";
			$msg = "Terjadi kesalahan saat menyimpan data rencana kegiatan efesiensi energi, silakan coba lagi.";
		}else{
			$status = "success";
			$msg = "Penyimpanan data rencana kegiatan efesiensi energi berhasil.";
		}

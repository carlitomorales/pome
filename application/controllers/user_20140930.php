...
class User extends CI_Controller {
	...
	public function add_save()
	{
		...
		$headers = 'From: manajemen.energi@ebtke.esdm.go.id' . "\r\n" .
			'Reply-To: manajemen.energi@ebtke.esdm.go.id' . "\r\n" .
	...
	public function add_kirim_pesan()
	{
		...
		if ($this->session->userdata('privilege_id')=='2' )
		{
			...
			$headers = "From: manajemen.energi@ebtke.esdm.go.id\r\n";
			$headers .= "Reply-To: manajemen.energi@ebtke.esdm.go.id\r\n";
			$headers .= "CC: manajemen.energi@ebtke.esdm.go.id\r\n";
	...
	public function add_save_change_email()
	{
		...
		$headers1 = 'From: manajemen.energi@ebtke.esdm.go.id' . "\r\n" .
		'Reply-To: manajemen.energi@ebtke.esdm.go.id' . "\r\n" .
		'X-Mailer: PHP/' . phpversion();

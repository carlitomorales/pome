...
class chartrencana extends CI_Controller {
	...
	{
		$this->load->view('chartrencana', $this->data);
	}
	...
	public function getpiedata(){
		...
		if($sub_sektor==0)
		{
			...
			->join("t_rencana_konservasi_new AS t", "a.id_peralatan_pemanfaat_energi=t.id_peralatan_pemanfaat_energi")	

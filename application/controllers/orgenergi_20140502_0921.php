...
class orgenergi extends CI_Controller {
	...
	public function index()
	{
		...
		if($querydata['OrgMgmntEnergi'] == '1'){
			...
			$this->data['adaorganisasi'] = " value=0 ";
			$this->data['tidakadaorganisasi'] = " value=1 checked";
		}		
		...
		if($querydata['MgrEnergi'] == '1'){
			...
			$this->data['adamanager'] = " value=0 ";
			$this->data['tidakadamanager'] = " value=1 checked";
		}
 ...
 public function save()
		...
		if(strtoupper($theext)=='PDF' && $_FILES['FileOrg']['name'] !='' ){
			$theupload = 'true';
		}else{
			$theupload = 'false';
		}

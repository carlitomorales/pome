...
class Peralatanpemanfaat extends CI_Controller {
	...
	function saveperalatanpemanfaatenergi(){
		...
		if($this->db->trans_status() === FALSE){
			$status = "error";
			$msg = "Terjadi kesalahan saat update data peralatan pemanfaat energi utama, silakan coba lagi.";
		}else{
			$status = "success";
			$msg = "Update data peralatan pemanfaat energi utama berhasil.";
		}

$(document).ready(function(){
	...
	{
		$('#bs-css').attr('href','http://aplikasi.ebtke.esdm.go.id/pome/css/bootstrap-'+theme_name+'.css');
	}
...
function formatCurrency(num, decimals, decimal_sep, thousands_sep)
{ 
   var n = num,
...
{
	objDate = new Date(jDate);
	sDate = objDate.getDate()+"-"+objDate.getMonth()+"-"+objDate.getYear();
	return sDate;
}